...
class PenjualanController extends Controller
{
    ...
    {
        $date_start = Carbon::parse("2021-09-01");
        $date_end = Carbon::now();
        ...
        if ($request->has("intnomorsales")) {
            $data = $data->where("intnomorsales", $request->intnomorsales);
        }

        $d["data"] = $data->whereBetween("createdOn", [$d["date_start"], $d["date_end"]])->orderBy("createdOn", "desc")->get();
