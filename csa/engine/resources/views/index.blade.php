...
<div class="content">
    ...
    <div class="row items-push">
            ...
            <div class="block block-rounded block-mode-loading-oneui h-100 mb-0">
                ...
                <div class="block-content block-content-full">
                    <div class="table-responsive">
                        <div class ="table-responsive"><table class="table table-striped table-hover table-borderless table-vcenter fs-sm mb-0 js-dataTable-buttons">
                            <thead>
        ...
        <div class="col-lg-6">
            <div class="block block-rounded block-mode-loading-oneui h-100 mb-0">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Konsumen</h3>
                        ...
                        <div class ="table-responsive"><table class="table table-striped table-hover table-borderless table-vcenter fs-sm mb-0 js-dataTable-buttons">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-sm-table-cell">
                                        <span class="fs-sm text-muted">{{$item->name}}</span>
                                    </td>
                                    <td>
                                        <span class="fw-semibold text-warning">{{$item->customer_phone_no}}</span>
                                    </td>
                                    <td class="d-sm-table-cell text-end">
