        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <div class="float-start">
                    <h3 class="block-title">Piutang</h3>
                </div>
                <div class="float-end">
                    <a href="{{route('piutang.create')}}" class="btn btn-info block-title">Buat Pembayaran</a>
                </div>
                ...
                <div class ="table-responsive"><table class="table table-responsive table-bordered table-striped table-vcenter js-dataTable-buttons">
                    ...
                    <tbody id="item-table">
                        @foreach($data as $key)<tr>
                            ...
                            <td>
                                <a target="_blank" href="{{route('konsumen.show', $key->salesorderheader->customer->id ?? 0)}}">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-primary">
                                        ...
                                        <form autocomplete="off" action="{{route('piutang.destroy',$key->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
