        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <div class="float-start">
                    <h3 class="block-title">Data Merk</h3>
                </div>
                <div class="float-end">
                    <a href="{{route('merk.create')}}" class="btn btn-info block-title">Tambah Merk</a>
                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-primary">
                                        <a class="dropdown-item"
                                            href="{{route('merk.edit',$category->id)}}">Edit</a>
                                        <a class="dropdown-item delete">Delete</a>
                                        <form autocomplete="off" action="{{route('merk.destroy',$category->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
