...
<div class="content w-100">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">{{$is_edit?"Ubah":"Tambah"}} Purchase Order Line</h3>
        </div>
        <div class="block-content block-content-full">
            <div class="row">
                <div class="col-lg-12 ">
                    <hr>
                    <form autocomplete="off" class="form-barang" action="{{route('po_line.update',$data->id)}}" method="post">
                        @csrf
                        @method("put")
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <select class="warehouse select2 form-control" name="warehouse_id"
                                            style="width: 100%">
                                            @foreach ($warehouses as $item)
                                            <option value="{{$item->id}}" data-item="{{$item}}" @if($item->id == $data->warehouse_id) selected @endif>
