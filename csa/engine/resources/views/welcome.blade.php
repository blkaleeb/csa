      ...
      <header id="page-header">
        ...
        <div class="content-header">
          ...
          <div class="d-flex align-items-center">
            <!-- Logo -->
            <a class="fw-semibold fs-5 tracking-wider text-dual me-3" href="index.html"> One<span class="fw-normal">UI</span> </a>
            <!-- END Logo -->
        ...
        <div id="page-header-search" class="overlay-header bg-body-extra-light">
          <div class="content-header">
            <form autocomplete="off" class="w-100" action="bd_search.html" method="POST">
          ...
          <div class="row items-push">
            ...
            <div class="col-lg-6">
              <div class="block block-rounded block-mode-loading-oneui h-100 mb-0">
                ...
                <div class="block-content block-content-full">
                  <div class ="table-responsive"><table class="table table-striped table-hover table-borderless table-vcenter fs-sm mb-0">
                    <thead>
