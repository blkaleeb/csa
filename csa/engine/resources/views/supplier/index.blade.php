    ...
    <div class="row">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <div class="float-end">
                    <a href="{{route("supplier.create")}}" class="btn btn-info block-title btn-sm">Tambah Supplier</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold fs-sm">
                                <a href="{{route('supplier.show',$supplier->id)}}">{{$supplier->supplier_name}}</a>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-primary">
                                        ...
                                        <form autocomplete="off" action="{{route('supplier.destroy',$supplier->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </div>
