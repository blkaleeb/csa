            ...
            <div class="row">
                <div class="col-lg-12 space-y-5">
                    ...
                    <form autocomplete="off" class="space-y-4 form-header"
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6">
                                <label class="form-label" for="example-ltf-email">Customer: {{$customer->name}}</label>
                            ...
                            <div class="col-lg-6">
                                <div class="">
                                    ...
                                    <p id="customer_address" style="margin: unset !important">
                                        {{$customer->customer_address ?? ""}} </p>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <label class="form-label" for="example-ltf-email">Penjualan {{$sales->intnomorsales}}</label>
                                ...
                                <div class="row mb-4">
                                    <div class="col-xl-12">
                                        ...
                                        <select class="stock select2 form-control" style="width: 100%">
                                            ...
                                            <option value="{{$item->stock->id}}" data-sales="{{$item}}" data-item="{{$item->stock}}">{{$item->stock->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
