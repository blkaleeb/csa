            ...
            <div class="row">
                <div class="col-lg-12 space-y-5">
                    ...
                    <form autocomplete="off" class="space-y-4 form-header"
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6">
                                <label class="form-label" for="example-ltf-email">Customer</label>
                                <select name="customer_id" id="" class="customer form-control select2">
                                    <option value="" disabled @if(!$is_edit) selected @endif>Pilih Customer</option>

                                    @foreach($customers as $customer)
                                    <option value="{{$customer->id}}" @if($is_edit && $data->customer_id ==
                                        $customer->id) selected @endif data-item="{{$customer}}"
                                        >
                                        {{$customer->name}}
                                    </option>
                                    @endforeach
                            ...
                            <div class="col-lg-12">
                                <label class="form-label" for="example-ltf-email">Pilih Penjualan</label>
                                <select name="sales_id" id="" class="po form-control select2">
                                    <option value="" disabled @if(!$is_edit) selected @endif>Pilih Penjualan</option>
                                </select>
                            </div>
                        </div>
