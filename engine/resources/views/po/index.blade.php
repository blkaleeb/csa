    ...
    <div class="row">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full table-responsive">
                <div class ="table-responsive"><table class="table table-hover table-vcenter js-dataTable-buttons no-footer">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Tanggal</th>
