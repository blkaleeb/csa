...
$(".po").change(function(){
    ...
    .done(function( msg ) {
        $.each(msg,function(k,v){
            var option = `<option value='`+v.stock.id+`' data-item='`+JSON.stringify(v)+`'>`+v.stock.name+`</option>`
            $(".stock").append(option);
        })
    });
})
...
// ////////////////////////////////////////////////////////////////////////
    ...
    var kodebarang = `<td><input type='hidden' value='`+datastock.stock.id+`' name="item_stock_id[]">`+datastock.stock.name+`</td>`
