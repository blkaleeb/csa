        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <div class="float-end">
                    ...
                    {{-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#penjualan">
                        Faktur
                      </button> --}}
                </div>
            </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-primary">
                                            <a class="dropdown-item"
                                                href="{{ route('piutang.create', ['salesid' => $item->id]) }}">Bayar</a>
                                            <a class="dropdown-item"
                                                href="{{ route('retur_penjualan.create', ['salesid' => $item->id]) }}">Buat
                                                Retur
                                                Faktur</a>
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('penjualan.print', $item->id) }}">Print</a>
