...
class PermintaanReturController extends Controller
{
    /**
    ...
    protected $view = "permintaan_retur.";
    protected $menu_header = "Daftar Permintaan Retur";
    protected $menu_title = "Daftar Permintaan Retur";
